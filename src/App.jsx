...
function App() {
  ...
  const storyEvents = [
    ...
    },
    {
      ...
      detail: '在森林的不同角落，調查小組成員在準備守夜時，驚見夜空中劃過一陣強烈的藍光，猶如無聲的爆炸。大B、米勒與安妮在森林的一隅目睹了這不可思議的景象，光芒將樹梢映照得如同白晝。同時，獨自行動的斯科特與正在處理活屍士兵的蒼浩也感受到了這股不安的震動。空氣中瀰漫著一種難以言喻的、壓抑且令人窒息的惡意，彷彿森林深處有什麼古老的東西正在甦醒。'
    },
    {
      id: 'event-chapter12',
      chapter: '第十二章',
    ...
    },
    {
      id: 'event-chapter27',
      chapter: '第二十七章',
      title: '後記：遺忘與餘響 (Epilogue: Oblivion & Echoes)',
      date: '1925年 秋',
      image: 'event_chapter27_final.webp',
      summary: '貝靈頓森林恢復了平靜，但留下來的人們，命運已永遠改變。',
      detail: '隨著貝靈頓開發案的崩潰與盧卡斯的自盡，那場恐怖的搜救正式宣告結束。斯科特 (Scott) 投身於為族人爭取正義的法律戰中，手中的證據成為了拆解盧卡斯集團的致命利刃。大B (Big B) 則在簡小姐的墓前學會了謙卑，他在墓碑前放下白花，慶幸生命的脆弱。米勒 (Miller) 拿著那張血色的支票消失在迷霧中，但心靈卻永遠被藍色的夢魘囚禁。安妮 (Annie) 靜靜地坐在牢房中，臉上帶著復仇後的淒冷與空洞。而蒼浩 (Cang Hao)，在啟程回國的甲板上，懷揣著舊友二虎絕命的秘密隨風而逝。森林依然矗立在東北方，靜靜地等待著下一個膽敢走入它陰影的人。'
    }
  ];
