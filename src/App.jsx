...
function App() {
  ...
  const storyEvents = [
    ...
    },
    {
      ...
      title: '木屋後的幽徑',
      date: '6月22日',
      image: 'event_chapter19_new.png',
      summary: '斯科特帶領簡小姐、大 B 與獵人父子穿過昏暗的森林小徑，成功避開搜查。',
      detail: '斯科特利用其對森林地形的直覺，帶領眾人穿過木屋後方一條被雜草淹沒的小徑。簡小姐在逃亡中顯得異常沉默，眼底透著一絲不易察覺的恐懼。大 B 則時刻警戒著後方是否有追兵。'
    },
    {
      id: 'event-chapter20',
      chapter: '第二十章',
      title: '湖畔的意外重逢',
      date: '6月22日',
      image: 'event_chapter20_new.png',
      summary: '安妮獨自往湖泊側邊的小路逃跑，並在途中遇見了剛從湖邊趕來的蒼浩與米勒。',
      detail: '眾人在低光且扭曲的森林環境中短暫重整，並交換了關於礦區與湖邊異變的情報。安妮將礦區爆炸的情況告知兩人，也得知了湖邊祭壇的慘狀。面對背後源源不斷傳來的非人咆哮，這支殘破的小隊決定在此地做最後的抵抗。'
    },
    {
      id: 'event-chapter21',
      chapter: '第二十一章',
    ...
    },
    {
      ...
      title: '復仇之火的餘燼',
      date: '6月23日',
      image: 'event_chapter24_new.png',
      summary: '簡小姐意外中毒身亡（安妮復仇），真相揭露其為安妮所殺，最終盧卡斯自盡。',
      detail: '就在眾人慶幸生還之際，簡小姐飲下安妮遞來的水後突然暴斃。真相揭開：安妮是盧卡斯當年拋棄的私生女，潛入盧卡斯家多年只為這毀滅性的一刻。得知雙親罪孽與兩名女兒悲劇的盧卡斯，在三天後舉槍身亡。這場由貪婪引發的慘劇，最終以灰燼告終，無人慶幸，無人救贖。'
    }
  ];
