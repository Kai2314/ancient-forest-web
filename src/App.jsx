...
function App() {
  ...
  const storyEvents = [
    ...
    },
    {
      ...
      detail: '在森林的不同角落，調查小組成員在準備守夜時，驚見夜空中劃過一陣強烈的藍光，猶如無聲的爆炸。同時，獨自行動的斯科特與正在處理活屍士兵的蒼浩也感受到了這股不安的震動。這股光芒持續了許久，空氣中瀰漫著一種難以言喻的量子波動感，彷彿森林深處有什麼古老的東西正在甦醒。'
    },
    {
      id: 'event-chapter11',
      chapter: '第十一章',
    ...
    },
    {
      ...
      title: '湖畔祭壇：血腥的活人獻祭',
      date: '6月22日 午後',
      image: 'event_chapter14_v1.png',
      summary: '湖邊矗立著被監刺貫穿卻「無法死去」的犧牲者。蒼浩在絕境中抓起監刺，擊殺了面無血色的活屍守衛。',
      detail: '抵達汙穢的湖邊，蒼浩目睹慘烈的獻祭場景：五名受害者被監刺釘在木樁上，內臟流出卻哀求著求死，聲稱靈魂正在被灼燒。一名面色慘白、眼含深淵的活屍守衛出現，其精神控制力令蒼浩瞬間癱瘓。米勒被波及誤傷，最後蒼浩憑藉意志抓起地上的監刺反擊，將監刺刺入守衛胸口才將其徹底殺死，並釋放了所有受害者的靈魂。'
    },
    {
      id: 'event-chapter15',
      chapter: '第十五至十六章',
