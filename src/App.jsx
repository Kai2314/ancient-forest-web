...
function App() {
  ...
  const storyEvents = [
    ...
    },
    {
      ...
      summary: '調查員們在森林高處發現了神情緊張的綁匪克雷頓。在一場短暫而慘烈的伏擊中，米勒成功近身，而大B在遠處開火擊碎了克雷頓的腿骨，成功將其生擒。',
      detail: '米勒利用潛行技巧悄無聲息地接近克雷頓，並用槍抵住其後腦。驚慌失措的克雷頓對天鳴槍，隨即被遠處大B的高端步槍精準射中腿部。重傷的克雷頓供認，綁票是為了傳聞中的「金礦」，但他們也一直在森林中遭遇無法解釋的超自然現象。'
    },
    {
      id: 'event4',
      chapter: '第九章',
